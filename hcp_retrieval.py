...
Original file is located at
    https://colab.research.google.com/drive/1ZDF2FxLLkNgTTzx87zbVFI2JThF2AfFc
"""
...
db3 = Chroma(persist_directory="/content/drive/MyDrive/VECTORS_HCP", collection_name="HCP_CONTENT_PLATFORM",embedding_function=embedding_func)
embeddings = db3.get(include=['documents','metadatas','embeddings'])

retriever1=db3.as_retriever()

# Initialize the storage layer
store_hcp  = LocalFileStore(root_path="/content/drive/MyDrive/PARENT_DOCUMENTS_HCP/")
id_key = "doc_id"
